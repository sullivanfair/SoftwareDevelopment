...
import com.example.volleytrials.TenantComplaints;
...
public class complaintsTest {
    ...
    @Rule
    public ActivityScenarioRule<TenantComplaints> tcRule = new ActivityScenarioRule<>(TenantComplaints.class);
    ...
    public void testOTDetails() {
        ...
        ActivityScenario<TenantComplaints> scenario = tcRule.getScenario();
        ...
        Espresso.onView(ViewMatchers.withId(R.id.complaintsTitle))
