...
public class likeDetailTest {
    ...
    public void testLikeDetails() {
        ...
        Log.d("LOGGGGGer", "NOT LIKED YYET");
        ...
        Espresso.onView(ViewMatchers.withId(R.id.DetNumLikes))
        ...
        Espresso.onView(ViewMatchers.withId(R.id.likeDet))
        ...
        Espresso.onView(withId(R.id.DetNumLikes))
                .check(matches(ViewMatchers.withText(beforeLike)));
